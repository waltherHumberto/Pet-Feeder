...
COMPONENT_LDFLAGS += -L$(BUILD_DIR_BASE)/esp_rom -lesp_rom -L $(IDF_PATH)/components/esp_rom/esp32/ld -T esp32.rom.ld -T esp32.rom.libgcc.ld -T esp32.rom.syscalls.ld -T esp32.rom.newlib-data.ld -T esp32.rom.newlib-funcs.ld -lesp_rom -Wl,--wrap=longjmp 
